...
const roomData = [
  {
    ...
    "desc": "Custom homes",
    "price": "From $200k+",
    "image": "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1400&q=85&sig=10"
  },
  {
    "title": "Commercial",
    "desc": "Office builds",
    "price": "From $500k+",
    "image": "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1400&q=85&sig=11"
  },
  {
    "title": "Renovations",
    "desc": "Full service",
    "price": "From $50k+",
    "image": "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xe67e22, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xe67e22, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xe67e22, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xe67e22, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xe67e22, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xe67e22, 0.5, 8);
