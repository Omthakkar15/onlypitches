...
const roomData = [
  {
    ...
    "desc": "24/7 access",
    "price": "From $49/mo",
    "image": "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=1400&q=85&sig=10"
  },
  {
    "title": "HIIT Classes",
    "desc": "Unlimited sessions",
    "price": "From $79/mo",
    "image": "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=1400&q=85&sig=11"
  },
  {
    "title": "Personal Training",
    "desc": "Certified coaches",
    "price": "From $65/session",
    "image": "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xff4757, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xff4757, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xff4757, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xff4757, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xff4757, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xff4757, 0.5, 8);
