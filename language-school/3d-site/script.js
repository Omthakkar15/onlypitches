...
const roomData = [
  {
    ...
    "desc": "12-week course",
    "price": "From $350",
    "image": "https://images.unsplash.com/photo-1546410531-bb4caa6b424d?w=1400&q=85&sig=10"
  },
  {
    "title": "Business English",
    "desc": "Professional focus",
    "price": "From $400",
    "image": "https://images.unsplash.com/photo-1546410531-bb4caa6b424d?w=1400&q=85&sig=11"
  },
  {
    "title": "Private Tutoring",
    "desc": "Flexible schedule",
    "price": "From $45/hr",
    "image": "https://images.unsplash.com/photo-1546410531-bb4caa6b424d?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xe74c3c, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xe74c3c, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xe74c3c, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xe74c3c, 0.25);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xe74c3c, 0.5, 8);
