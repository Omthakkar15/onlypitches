...
const roomData = [
  {
    ...
    "price": "From $14",
    "image": "https://images.unsplash.com/photo-1572116463496-5d3fa3ff0ff4?w=1400&q=85&sig=10"
  },
  {
    "title": "Wagyu Sliders",
    "desc": "Three mini brioche buns",
    "price": "From $18",
    "image": "https://images.unsplash.com/photo-1572116463496-5d3fa3ff0ff4?w=1400&q=85&sig=11"
  },
  {
    "title": "Truffle Fries",
    "desc": "Parmesan, aioli",
    "price": "From $10",
    "image": "https://images.unsplash.com/photo-1572116463496-5d3fa3ff0ff4?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xe85d04, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xe85d04, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xe85d04, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xe85d04, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xe85d04, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xe85d04, 0.5, 8);
