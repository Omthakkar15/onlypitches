...
const roomData = [
  {
    ...
    "desc": "Private patio",
    "price": "From $145",
    "image": "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=1400&q=85&sig=10"
  },
  {
    "title": "Attic Suite",
    "desc": "Skylight views",
    "price": "From $175",
    "image": "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=1400&q=85&sig=11"
  },
  {
    "title": "Farm Breakfast",
    "desc": "Local organic",
    "price": "Contact us",
    "image": "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xc9b896, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xc9b896, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xc9b896, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xc9b896, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xc9b896, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xc9b896, 0.5, 8);
