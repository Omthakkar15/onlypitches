...
const roomData = [
  {
    ...
    "desc": "Small batches",
    "price": "From $800/mo",
    "image": "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=1400&q=85&sig=10"
  },
  {
    "title": "CBSE Classes",
    "desc": "Grades 9–12",
    "price": "From $500/mo",
    "image": "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=1400&q=85&sig=11"
  },
  {
    "title": "Doubt Sessions",
    "desc": "Daily support",
    "price": "Contact us",
    "image": "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0x4361ee, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0x4361ee, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0x4361ee, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0x4361ee, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0x4361ee, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0x4361ee, 0.5, 8);
