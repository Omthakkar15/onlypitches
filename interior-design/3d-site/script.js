...
const roomData = [
  {
    ...
    "desc": "Turnkey design",
    "price": "From $15k+",
    "image": "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=1400&q=85&sig=10"
  },
  {
    "title": "Kitchen Remodel",
    "desc": "Layout & finishes",
    "price": "From $8k+",
    "image": "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=1400&q=85&sig=11"
  },
  {
    "title": "Virtual Consult",
    "desc": "1-hour video",
    "price": "From $250",
    "image": "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xc9a87c, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xc9a87c, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xc9a87c, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xc9a87c, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xc9a87c, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xc9a87c, 0.5, 8);
