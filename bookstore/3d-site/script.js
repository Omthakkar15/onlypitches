...
const roomData = [
  {
    "title": "New Releases",
    "desc": "Hardcover & paperback",
    "price": "From $18+",
    "image": "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=1400&q=85&sig=10"
  },
  {
    "title": "Rare Books",
    "desc": "Collector editions",
    "price": "From $50+",
    "image": "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=1400&q=85&sig=11"
  },
  {
    "title": "Book Club",
    "desc": "Monthly gatherings",
    "price": "Contact us",
    "image": "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0x8b4513, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0x8b4513, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0x8b4513, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0x8b4513, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0x8b4513, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0x8b4513, 0.5, 8);
