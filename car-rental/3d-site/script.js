...
const roomData = [
  {
    ...
    "desc": "Fuel efficient",
    "price": "From $29/day",
    "image": "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=1400&q=85&sig=10"
  },
  {
    "title": "SUV",
    "desc": "Family trips",
    "price": "From $59/day",
    "image": "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=1400&q=85&sig=11"
  },
  {
    "title": "Luxury",
    "desc": "Premium brands",
    "price": "From $99/day",
    "image": "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xe94560, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xe94560, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xe94560, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xe94560, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xe94560, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xe94560, 0.5, 8);
