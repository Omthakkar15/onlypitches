...
const roomData = [
  {
    ...
    "desc": "GIA certified",
    "price": "From $2000+",
    "image": "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=1400&q=85&sig=10"
  },
  {
    "title": "Custom Design",
    "desc": "From sketch to stone",
    "price": "From $500+",
    "image": "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=1400&q=85&sig=11"
  },
  {
    "title": "Watch Repair",
    "desc": "Expert horologists",
    "price": "From $50+",
    "image": "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xd4af37, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xd4af37, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xd4af37, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xd4af37, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xd4af37, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xd4af37, 0.5, 8);
