...
const roomData = [
  {
    ...
    "desc": "48-hour ferment",
    "price": "From $8",
    "image": "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=1400&q=85&sig=10"
  },
  {
    "title": "Pain au Chocolat",
    "desc": "French butter layers",
    "price": "From $4",
    "image": "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=1400&q=85&sig=11"
  },
  {
    "title": "Celebration Cake",
    "desc": "Custom flavors",
    "price": "From $65",
    "image": "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xe8b86d, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xe8b86d, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xe8b86d, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xe8b86d, 0.25);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xe8b86d, 0.5, 8);
