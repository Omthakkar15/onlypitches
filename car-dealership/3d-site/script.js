...
const roomData = [
  {
    ...
    "desc": "Latest models",
    "price": "From $25k+",
    "image": "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=1400&q=85&sig=10"
  },
  {
    "title": "Certified Pre-Owned",
    "desc": "Warranty included",
    "price": "From $15k+",
    "image": "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=1400&q=85&sig=11"
  },
  {
    "title": "Trade-In",
    "desc": "Instant appraisal",
    "price": "Contact us",
    "image": "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xc0392b, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xc0392b, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xc0392b, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xc0392b, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xc0392b, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xc0392b, 0.5, 8);
