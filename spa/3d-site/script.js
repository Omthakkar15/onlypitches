...
const roomData = [
  {
    "title": "Deep Tissue",
    "desc": "60 min full body",
    "price": "From $120",
    "image": "https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=1400&q=85&sig=10"
  },
  {
    "title": "Facial Glow",
    "desc": "Organic botanicals",
    "price": "From $95",
    "image": "https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=1400&q=85&sig=11"
  },
  {
    "title": "Hot Stone",
    "desc": "Volcanic river stones",
    "price": "From $140",
    "image": "https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0x7eb8a4, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0x7eb8a4, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0x7eb8a4, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0x7eb8a4, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0x7eb8a4, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0x7eb8a4, 0.5, 8);
