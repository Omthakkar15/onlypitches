...
const roomData = [
  {
    ...
    "desc": "Quarterly plan",
    "price": "From $89",
    "image": "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=1400&q=85&sig=10"
  },
  {
    "title": "Termite Treatment",
    "desc": "Full barrier",
    "price": "From $800+",
    "image": "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=1400&q=85&sig=11"
  },
  {
    "title": "Rodent Control",
    "desc": "Humane removal",
    "price": "From $150",
    "image": "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0x27ae60, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0x27ae60, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0x27ae60, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0x27ae60, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0x27ae60, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0x27ae60, 0.5, 8);
