...
const roomData = [
  {
    ...
    "price": "From $5000+",
    "image": "https://images.unsplash.com/photo-1552664730-d307ca884978?w=1400&q=85&sig=10"
  },
  {
    "title": "Operations",
    "desc": "Process optimization",
    "price": "Contact us",
    "image": "https://images.unsplash.com/photo-1552664730-d307ca884978?w=1400&q=85&sig=11"
  },
  {
    "title": "Digital Transform",
    "desc": "Tech adoption",
    "price": "From $10k+",
    "image": "https://images.unsplash.com/photo-1552664730-d307ca884978?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0x7b68ee, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0x7b68ee, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0x7b68ee, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0x7b68ee, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0x7b68ee, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0x7b68ee, 0.5, 8);
