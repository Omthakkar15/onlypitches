...
const roomData = [
  {
    ...
    "desc": "2-bed apartment",
    "price": "From $120",
    "image": "https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=1400&q=85&sig=10"
  },
  {
    "title": "Deep Clean",
    "desc": "Full top-to-bottom",
    "price": "From $220",
    "image": "https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=1400&q=85&sig=11"
  },
  {
    "title": "Move-Out",
    "desc": "Deposit-back guarantee",
    "price": "From $280",
    "image": "https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0x00cec9, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0x00cec9, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0x00cec9, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0x00cec9, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0x00cec9, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0x00cec9, 0.5, 8);
