...
const roomData = [
  {
    title: "Deluxe Room",
    desc: "A cozy, luminous retreat with king bedding and city skyline views.",
    price: "From $340/night",
    image: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=1400&q=85",
  },
  {
    title: "Executive Suite",
    desc: "Spacious lounge, private bar corner, and bespoke concierge touches.",
    price: "From $560/night",
    image: "https://images.unsplash.com/photo-1611892440504-42a784e15d7f?w=1400&q=85",
  },
  {
    title: "Presidential Suite",
    desc: "Signature top-floor residence with private dining and panoramic skyline.",
    price: "From $1,150/night",
    image: "https://images.unsplash.com/photo-1578683010236-d716f9a3fdf6?w=1400&q=85",
  },
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xc9a15a, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xc9a15a, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xc9a15a, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xc9a15a, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xc9a15a, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xc9a15a, 0.5, 8);
