...
const roomData = [
  {
    ...
    "desc": "7-day Kenya",
    "price": "From $3500",
    "image": "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=1400&q=85&sig=10"
  },
  {
    "title": "Trekking",
    "desc": "Nepal Himalayas",
    "price": "From $2000",
    "image": "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=1400&q=85&sig=11"
  },
  {
    "title": "Cultural Tours",
    "desc": "Small group",
    "price": "From $1500",
    "image": "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0x2ecc71, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0x2ecc71, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0x2ecc71, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0x2ecc71, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0x2ecc71, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0x2ecc71, 0.5, 8);
