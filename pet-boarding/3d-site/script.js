...
const roomData = [
  {
    ...
    "desc": "Indoor play",
    "price": "From $35/night",
    "image": "https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=1400&q=85&sig=10"
  },
  {
    "title": "Luxury Suite",
    "desc": "Private room",
    "price": "From $55/night",
    "image": "https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=1400&q=85&sig=11"
  },
  {
    "title": "Daycare",
    "desc": "Social play groups",
    "price": "From $25/day",
    "image": "https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xe9c46a, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xe9c46a, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xe9c46a, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xe9c46a, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xe9c46a, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xe9c46a, 0.5, 8);
