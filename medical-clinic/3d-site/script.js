...
const roomData = [
  {
    ...
    "price": "From $150",
    "image": "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=1400&q=85&sig=10"
  },
  {
    "title": "Pediatrics",
    "desc": "Ages 0–18",
    "price": "Contact us",
    "image": "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=1400&q=85&sig=11"
  },
  {
    "title": "Telehealth",
    "desc": "Video consultations",
    "price": "From $75",
    "image": "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0x2ec4b6, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0x2ec4b6, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0x2ec4b6, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0x2ec4b6, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0x2ec4b6, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0x2ec4b6, 0.5, 8);
