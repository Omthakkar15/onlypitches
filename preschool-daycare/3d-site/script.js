...
const roomData = [
  {
    ...
    "desc": "Ages 2–3",
    "price": "From $900/mo",
    "image": "https://images.unsplash.com/photo-1587654780291-39c9404d746b?w=1400&q=85&sig=10"
  },
  {
    "title": "Preschool",
    "desc": "Ages 3–5",
    "price": "From $800/mo",
    "image": "https://images.unsplash.com/photo-1587654780291-39c9404d746b?w=1400&q=85&sig=11"
  },
  {
    "title": "After School",
    "desc": "Until 6pm",
    "price": "From $400/mo",
    "image": "https://images.unsplash.com/photo-1587654780291-39c9404d746b?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xff6b6b, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xff6b6b, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xff6b6b, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xff6b6b, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xff6b6b, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xff6b6b, 0.5, 8);
