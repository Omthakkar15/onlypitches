...
const roomData = [
  {
    ...
    "desc": "Creamy arborio with black truffle",
    "price": "From $38",
    "image": "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1400&q=85&sig=10"
  },
  {
    "title": "Wood-Fired Salmon",
    "desc": "Citrus glaze, seasonal greens",
    "price": "From $44",
    "image": "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1400&q=85&sig=11"
  },
  {
    "title": "Chocolate Soufflé",
    "desc": "Warm, molten center",
    "price": "From $16",
    "image": "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xc45c26, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xc45c26, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xc45c26, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xc45c26, 0.25);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xc45c26, 0.5, 8);
