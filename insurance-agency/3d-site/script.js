...
const roomData = [
  {
    ...
    "price": "From $89/mo",
    "image": "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1400&q=85&sig=10"
  },
  {
    "title": "Home Insurance",
    "desc": "Full replacement",
    "price": "Contact us",
    "image": "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1400&q=85&sig=11"
  },
  {
    "title": "Life Insurance",
    "desc": "Term policies",
    "price": "From $25/mo",
    "image": "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0x4895ef, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0x4895ef, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0x4895ef, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0x4895ef, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0x4895ef, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0x4895ef, 0.5, 8);
