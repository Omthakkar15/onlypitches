...
const roomData = [
  {
    ...
    "desc": "Bath, cut, nails",
    "price": "From $55",
    "image": "https://images.unsplash.com/photo-1516734212186-a967f81ad0d4?w=1400&q=85&sig=10"
  },
  {
    "title": "Nail Trim",
    "desc": "Quick service",
    "price": "From $15",
    "image": "https://images.unsplash.com/photo-1516734212186-a967f81ad0d4?w=1400&q=85&sig=11"
  },
  {
    "title": "De-Shedding",
    "desc": "Reduce shedding 80%",
    "price": "From $40",
    "image": "https://images.unsplash.com/photo-1516734212186-a967f81ad0d4?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xf4a261, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xf4a261, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xf4a261, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xf4a261, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xf4a261, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xf4a261, 0.5, 8);
