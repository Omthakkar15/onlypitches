...
const roomData = [
  {
    ...
    "price": "From $2500+",
    "image": "https://images.unsplash.com/photo-1452587925148-ce544e77e70d?w=1400&q=85&sig=10"
  },
  {
    "title": "Portrait",
    "desc": "Studio or outdoor",
    "price": "From $250",
    "image": "https://images.unsplash.com/photo-1452587925148-ce544e77e70d?w=1400&q=85&sig=11"
  },
  {
    "title": "Commercial",
    "desc": "Product & brand",
    "price": "From $500+",
    "image": "https://images.unsplash.com/photo-1452587925148-ce544e77e70d?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xffffff, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xffffff, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xffffff, 0.25);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xffffff, 0.5, 8);
