...
const roomData = [
  {
    ...
    "desc": "Shape, buff, polish",
    "price": "From $35",
    "image": "https://images.unsplash.com/photo-1604654894610-df63bc536371?w=1400&q=85&sig=10"
  },
  {
    "title": "Gel Extensions",
    "desc": "Long-lasting wear",
    "price": "From $65",
    "image": "https://images.unsplash.com/photo-1604654894610-df63bc536371?w=1400&q=85&sig=11"
  },
  {
    "title": "Nail Art",
    "desc": "Custom designs",
    "price": "From $15+",
    "image": "https://images.unsplash.com/photo-1604654894610-df63bc536371?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xf72585, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xf72585, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xf72585, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xf72585, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xf72585, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xf72585, 0.5, 8);
