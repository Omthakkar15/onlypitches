...
const roomData = [
  {
    ...
    "desc": "Full reception",
    "price": "From $1200",
    "image": "https://images.unsplash.com/photo-1571266028247-e4733b0f92ea?w=1400&q=85&sig=10"
  },
  {
    "title": "Corporate Event",
    "desc": "Background & dance",
    "price": "From $800",
    "image": "https://images.unsplash.com/photo-1571266028247-e4733b0f92ea?w=1400&q=85&sig=11"
  },
  {
    "title": "Private Party",
    "desc": "4-hour set",
    "price": "From $500",
    "image": "https://images.unsplash.com/photo-1571266028247-e4733b0f92ea?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xff006e, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xff006e, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xff006e, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xff006e, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xff006e, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xff006e, 0.5, 8);
