...
const roomData = [
  {
    ...
    "desc": "Buy & sell homes",
    "price": "From $Varies",
    "image": "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1400&q=85&sig=10"
  },
  {
    "title": "Commercial",
    "desc": "Office & retail",
    "price": "Contact us",
    "image": "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1400&q=85&sig=11"
  },
  {
    "title": "Property Management",
    "desc": "Full service",
    "price": "From $150/mo",
    "image": "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xe07a5f, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xe07a5f, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xe07a5f, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xe07a5f, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xe07a5f, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xe07a5f, 0.5, 8);
