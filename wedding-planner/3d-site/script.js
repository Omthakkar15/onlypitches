...
const roomData = [
  {
    "title": "Full Planning",
    "desc": "Every detail managed",
    "price": "From $5000+",
    "image": "https://images.unsplash.com/photo-1519741497674-611481863552?w=1400&q=85&sig=10"
  },
  {
    "title": "Day-Of Coord",
    "desc": "Timeline & vendors",
    "price": "From $1500",
    "image": "https://images.unsplash.com/photo-1519741497674-611481863552?w=1400&q=85&sig=11"
  },
  {
    "title": "Destination",
    "desc": "Travel weddings",
    "price": "From $8000+",
    "image": "https://images.unsplash.com/photo-1519741497674-611481863552?w=1400&q=85&sig=12"
  }
];
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xd4a5a5, 0.25);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xd4a5a5, 0.5, 8);
