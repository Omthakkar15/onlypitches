...
const roomData = [
  {
    "title": "Corporate Law",
    "desc": "Contracts & compliance",
    "price": "Contact us",
    "image": "https://images.unsplash.com/photo-1589829545855-d10d557cf95f?w=1400&q=85&sig=10"
  },
  {
    "title": "Family Law",
    "desc": "Divorce & custody",
    "price": "Contact us",
    "image": "https://images.unsplash.com/photo-1589829545855-d10d557cf95f?w=1400&q=85&sig=11"
  },
  {
    "title": "Litigation",
    "desc": "Trial-ready team",
    "price": "Contact us",
    "image": "https://images.unsplash.com/photo-1589829545855-d10d557cf95f?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xc9a227, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xc9a227, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xc9a227, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xc9a227, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xc9a227, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xc9a227, 0.5, 8);
