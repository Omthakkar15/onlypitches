...
const roomData = [
  {
    ...
    "price": "From $1200+",
    "image": "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=1400&q=85&sig=10"
  },
  {
    "title": "Dining Sets",
    "desc": "Solid oak",
    "price": "From $800+",
    "image": "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=1400&q=85&sig=11"
  },
  {
    "title": "Custom Orders",
    "desc": "Made to measure",
    "price": "From 8 wks",
    "image": "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xa67c52, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xa67c52, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xa67c52, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xa67c52, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xa67c52, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xa67c52, 0.5, 8);
