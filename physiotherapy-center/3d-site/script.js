...
const roomData = [
  {
    ...
    "desc": "45-minute eval",
    "price": "From $95",
    "image": "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=1400&q=85&sig=10"
  },
  {
    "title": "Manual Therapy",
    "desc": "Per session",
    "price": "From $85",
    "image": "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=1400&q=85&sig=11"
  },
  {
    "title": "Post-Surgery Rehab",
    "desc": "Insurance accepted",
    "price": "Contact us",
    "image": "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0x4cc9f0, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0x4cc9f0, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0x4cc9f0, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0x4cc9f0, 0.25);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0x4cc9f0, 0.5, 8);
