...
const roomData = [
  {
    ...
    "desc": "Annual checkup",
    "price": "From $65",
    "image": "https://images.unsplash.com/photo-1628009365241-3721a94ab852?w=1400&q=85&sig=10"
  },
  {
    "title": "Surgery",
    "desc": "Spay & neuter",
    "price": "From $200+",
    "image": "https://images.unsplash.com/photo-1628009365241-3721a94ab852?w=1400&q=85&sig=11"
  },
  {
    "title": "Emergency",
    "desc": "Urgent care line",
    "price": "From 24hr",
    "image": "https://images.unsplash.com/photo-1628009365241-3721a94ab852?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0x52b788, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0x52b788, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0x52b788, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0x52b788, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0x52b788, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0x52b788, 0.5, 8);
