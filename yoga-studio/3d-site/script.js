...
const roomData = [
  {
    "title": "Vinyasa Flow",
    "desc": "All levels welcome",
    "price": "From $18",
    "image": "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=1400&q=85&sig=10"
  },
  {
    "title": "Yin & Restore",
    "desc": "Deep stretch",
    "price": "From $16",
    "image": "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=1400&q=85&sig=11"
  },
  {
    "title": "Monthly Unlimited",
    "desc": "Any class, any time",
    "price": "From $120",
    "image": "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xa8dadc, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xa8dadc, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xa8dadc, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xa8dadc, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xa8dadc, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xa8dadc, 0.5, 8);
