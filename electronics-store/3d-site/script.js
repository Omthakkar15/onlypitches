...
const roomData = [
  {
    "title": "Laptops",
    "desc": "Latest processors",
    "price": "From $599+",
    "image": "https://images.unsplash.com/photo-1498049794561-7780f7231661?w=1400&q=85&sig=10"
  },
  {
    "title": "Smart Home",
    "desc": "Voice assistants",
    "price": "From $49+",
    "image": "https://images.unsplash.com/photo-1498049794561-7780f7231661?w=1400&q=85&sig=11"
  },
  {
    "title": "Repair Service",
    "desc": "Same-day fixes",
    "price": "From $39+",
    "image": "https://images.unsplash.com/photo-1498049794561-7780f7231661?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0x00d4ff, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0x00d4ff, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0x00d4ff, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0x00d4ff, 0.25);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0x00d4ff, 0.5, 8);
