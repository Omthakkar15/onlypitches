...
const roomData = [
  {
    ...
    "desc": "Buffet or boxed",
    "price": "From $28/head",
    "image": "https://images.unsplash.com/photo-1555244167-60d4be0a6d70?w=1400&q=85&sig=10"
  },
  {
    "title": "Gala Dinner",
    "desc": "Five-course plated",
    "price": "From $85/head",
    "image": "https://images.unsplash.com/photo-1555244167-60d4be0a6d70?w=1400&q=85&sig=11"
  },
  {
    "title": "Cocktail Reception",
    "desc": "Passed hors d'oeuvres",
    "price": "From $45/head",
    "image": "https://images.unsplash.com/photo-1555244167-60d4be0a6d70?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xb8860b, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xb8860b, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xb8860b, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xb8860b, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xb8860b, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xb8860b, 0.5, 8);
