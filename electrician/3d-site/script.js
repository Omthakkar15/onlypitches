...
const roomData = [
  {
    ...
    "desc": "Per outlet",
    "price": "From $85+",
    "image": "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=1400&q=85&sig=10"
  },
  {
    "title": "EV Charger",
    "desc": "Tesla certified",
    "price": "From $1200+",
    "image": "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=1400&q=85&sig=11"
  },
  {
    "title": "Whole Home Rewire",
    "desc": "Free estimate",
    "price": "Contact us",
    "image": "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0xf1c40f, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0xf1c40f, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0xf1c40f, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0xf1c40f, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0xf1c40f, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0xf1c40f, 0.5, 8);
