...
const roomData = [
  {
    ...
    "price": "From $10k+",
    "image": "https://images.unsplash.com/photo-1519167758481-83f550bb49b3?w=1400&q=85&sig=10"
  },
  {
    "title": "Private Parties",
    "desc": "Birthdays & anniversaries",
    "price": "From $3k+",
    "image": "https://images.unsplash.com/photo-1519167758481-83f550bb49b3?w=1400&q=85&sig=11"
  },
  {
    "title": "Full Planning",
    "desc": "End-to-end management",
    "price": "From $5k+",
    "image": "https://images.unsplash.com/photo-1519167758481-83f550bb49b3?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0x9b59b6, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0x9b59b6, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0x9b59b6, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0x9b59b6, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0x9b59b6, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0x9b59b6, 0.5, 8);
