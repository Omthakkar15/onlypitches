...
const roomData = [
  {
    ...
    "desc": "Exam and cleaning",
    "price": "From $120",
    "image": "https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=1400&q=85&sig=10"
  },
  {
    "title": "Invisalign",
    "desc": "Clear aligners",
    "price": "From $3500",
    "image": "https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=1400&q=85&sig=11"
  },
  {
    "title": "Emergency Care",
    "desc": "Walk-ins welcome",
    "price": "Contact us",
    "image": "https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=1400&q=85&sig=12"
  }
];
...
function initHeroScene() {
  ...
  heroScene.add(dir);
  const point = new THREE.PointLight(0x00a8e8, 1.5, 20);
  ...
  const pMat = new THREE.PointsMaterial({ color: 0x00a8e8, size: 0.05, transparent: true, opacity: 0.65 });
...
function initAmbientScene() {
  ...
  ambientPoints = new THREE.Points(geo, new THREE.PointsMaterial({ color: 0x00a8e8, size: 0.06, transparent: true, opacity: 0.28 }));
...
function buildAmenityIcon(type) {
  ...
  const goldGlow = goldMaterial(0x00a8e8, 0.25);
...
function initRoomViewer() {
  ...
  roomScene.add(light);
  const rim = new THREE.DirectionalLight(0x00a8e8, 0.35);
...
function initAmenities3D() {
  ...
  canvases.forEach((canvas) => {
    ...
    scene.add(dl);
    const accent = new THREE.PointLight(0x00a8e8, 0.5, 8);
